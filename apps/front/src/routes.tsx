...
const OrdersTablePage = lazy(
	() => import("./subadminComponents/orders/ManageOrders")
);
const UploadYoutube = lazy(
	() => import("../src/subadminComponents/youtube/UploadYoutube")
);
const UploadCertificate = lazy(
	() => import("../src/subadminComponents/certificate/ManageCertificates")
);
const AppointmentForm = lazy(
	() => import("../src/subadminComponents/AppointmentForm/AppointmentForm")
);
//Male Components
const MaleSpecialOffers = lazy(
	() => import("./subadminComponents/Male/specialoffers/MaleSpecialOffers")
);
const ManageMalePackages = lazy(
	() => import("./subadminComponents/Male/ourpackages/ManageMalePackages")
);
const MaleProducts = lazy(
	() => import("./subadminComponents/Male/products/MaleProducts")
);
const MaleProductPackages = lazy(
	() => import("./subadminComponents/Male/productpackages/MaleProductPackages")
);
const MaleOurServices = lazy(
	() => import("./subadminComponents/Male/ourservice/MaleOurServices")
);
const MaleHomeService = lazy(
	() => import("./subadminComponents/Male/homeservice/MaleHomeService")
);
//const MaleHomeService = lazy(()=>import("./subadminComponents/Male/homeservice/MaleService"));
//Female Components
const FemaleSpecialOffers = lazy(
	() => import("./subadminComponents/female/specialoffers/FemaleSpecialOffers")
);
const ManageFemalePackages = lazy(
	() => import("./subadminComponents/female/ourpackages/FemalePackages")
);
const FemaleProducts = lazy(
	() => import("./subadminComponents/female/products/FemaleProducts")
);
const FemaleProductPackages = lazy(
	() =>
		import("./subadminComponents/female/productpackages/FemaleProductPackages")
);
const ManageAboutSalon = lazy(
	() => import("./subadminComponents/AboutOurSalon/ManageAboutSalon")
);
const FemaleOurServices = lazy(
	() => import("./subadminComponents/female/ourservice/FemaleOurServices")
);
const FemaleHomeService = lazy(
	() => import("./subadminComponents/female/homeservice/FemaleHomeService")
);
//const FemaleHomeService = lazy(()=>import("./subadminComponents/female/homeservice/FemaleService"));
//Documents
const ManageAboutUs = lazy(
	() => import("./subadminComponents/documents/AboutUs/ManageAboutUs")
);
const ManagePrivacyPolicy = lazy(
	() =>
		import("./subadminComponents/documents/PrivacyPolicy/ManagePrivacyPolicy")
);
const ManageTermsCondition = lazy(
	() =>
		import(
			"./subadminComponents/documents/TermsAndConditions/ManageTermsCondition"
		)
);
const UsersTablePage = lazy(
	() => import("../src/commonComp/Dashbordes/UsersTablePage")
);
