...
exports.deleteAboutSalon =
	exports.updateAboutSalon =
	exports.getAboutSalonById =
	exports.getAllAboutSalon =
	exports.createAboutSalon =
		void 0;
const aboutSalon_service_1 = __importDefault(
	require("../services/aboutSalon.service")
);
...
const updateAboutSalon = async (req, res) => {
	try {
		...
		const updated = await aboutSalon_service_1.default.updateById(
			req.params.id,
			updateData
		);
		if (!updated)
...
const deleteAboutSalon = async (req, res) => {
	try {
		const deleted = await aboutSalon_service_1.default.deleteById(
			req.params.id
		);
		if (!deleted)
			return res
